...
const topicConfigs: Record<string, LearningTopicConfig> = {
  ...
  "barista-espresso-setup": { shortTitle: "Настройка эспрессо", role: "barista", source: "Demo KB · Стандарт настройки эспрессо" },
  "barista-grind-dose-tamp": { shortTitle: "Помол, доза и трамбовка", role: "barista", source: "Demo KB · Карта помола и дозы" },
  "barista-extraction-sensory": { shortTitle: "Экстракция и сенсорика", role: "barista", source: "Demo KB · Сенсорный чек-лист эспрессо" },
  "barista-milk-texture": { shortTitle: "Молоко и текстура", role: "barista", source: "Demo KB · Стандарт молока для напитков" },
  "barista-drink-recipes": { shortTitle: "Рецептуры напитков", role: "barista", source: "Demo KB · Рецептуры базовых напитков" },
...
function createLearningTopicMaterial(
  ...
  return {
    ...config,
    day1Task: `Разобрать demo-стандарт «${config.shortTitle}»: что проверить до первого напитка, где источник правила и когда остановиться для уточнения у наставника.`,
