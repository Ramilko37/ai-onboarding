...
export const assistantReplies: Record<string, string> = {
  "С чего начать сегодня?":
    "Начните с диагностики — это 14 вопросов и около 7 минут без оценок. После неё появится персональный маршрут и лишние знакомые темы уйдут в короткое повторение.",
  "Что делать с быстрым проливом?":
    "Проверьте помол, дозу, распределение и актуальный рецепт эспрессо. Если сомневаетесь, подключите старшего бариста до выдачи спорного шота.",
  "Что важно в первый день?":
